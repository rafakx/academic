...
class TeacherCoursesControllerTest < ActionController::TestCase
  ...
  test "should create teacher_course" do
    assert_difference('TeacherCourse.count') do
      post :create, teacher_course: { course_id: @teacher_course.course_id, course_type_id: @teacher_course.course_type_id, year: @teacher_course.year }
    end
  ...
  test "should update teacher_course" do
    patch :update, id: @teacher_course, teacher_course: { course_id: @teacher_course.course_id, course_type_id: @teacher_course.course_type_id, year: @teacher_course.year }
    assert_redirected_to teacher_course_path(assigns(:teacher_course))
  end
